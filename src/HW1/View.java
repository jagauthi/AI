...
public class View extends JPanel implements MouseListener {
	...
	public void shape(int id, int red, int green, int blue, int x1, int y1, int x2, int y2, int x3, int y3)
	{
	...
	public void shape(int id, int red, int green, int blue, int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4)
	{
